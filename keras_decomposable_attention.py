...
def build_model(vectors, shape, settings):
    '''Compile the model.'''
    max_length, nr_hidden, nr_class = shape   #shape = (max_length=100, nr_hidden, 3) 3 for entailment/contradiction/neutral
    # Declare inputs.
...
#BiRNNEncoding(max_length, nr_hidden, dropout=settings['dropout'])
class _BiRNNEncoding(object):
    def __init__(self, max_length, nr_out, dropout=0.0):
        ...
        self.model.add(TimeDistributed(Dense(nr_out, activation='relu', kernel_initializer='he_normal')))
...
# attend = _Attention(max_length=100, nr_hidden, dropout=settings['dropout'])
...
def test_build_model():
    ...
    shape = (10, 16, 3) # max length, hidden, task specific output
