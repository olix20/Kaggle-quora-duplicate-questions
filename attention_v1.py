...
def createModel():
	...
	regressor_model.add(Dense(200, name='entail1',kernel_initializer='he_normal',activation='relu',input_shape=(nr_hidden*2,)))
...
def trainModel(model,X_train,X_test,y_train,y_test):
	...
	MODEL_WEIGHTS_FILE = path+'weights/attention_v1_epoch_{epoch:02d}_val_loss_{val_loss:.2f}.h5'
